...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'username', 'salt', 'password', 'rolesUsers', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'isActive'];
        }
    ...
    public function setRolesUsers(\AppBundle\Entity\Role $rolesUsers = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRolesUsers', [$rolesUsers]);

        return parent::setRolesUsers($rolesUsers);
    }
