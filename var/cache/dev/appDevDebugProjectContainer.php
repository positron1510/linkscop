...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('y-5d2oqlou', '', (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('U+AA6znpn5', '', 'a7uPW9QkLs4yxEAX6HI1Og', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('q8e-NlFrA5', '', 'a7uPW9QkLs4yxEAX6HI1Og', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SluVGdDBrr', '', 'a7uPW9QkLs4yxEAX6HI1Og', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => 'localhost', 'port' => 5432, 'dbname' => 'linkscop', 'user' => 'linkscop', 'password' => 'i3t6PJ7aa6', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0e8ffac021f93378ab2302cbaaa0bfed2408bad4b3e2cc7293d074cc1885ed7b');
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'AppBundle' => ($this->targetDirs[3].'/src/AppBundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/FOS/RestBundle/Resources/config/serializer'), 'Snc\\RedisBundle' => ($this->targetDirs[3].'/vendor/snc/redis-bundle/Resources/config/serializer'), 'Nelmio\\ApiDocBundle' => ($this->targetDirs[3].'/vendor/nelmio/api-doc-bundle/Nelmio/ApiDocBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'OldSound\\RabbitMqBundle' => ($this->targetDirs[3].'/vendor/php-amqplib/rabbitmq-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Resources/config/serializer')));
    ...
    {
        return $this->services['parser_majestic'] = new \AppBundle\Services\Parser\Majestic($this->get('snc_redis.default'), '16FBBF1DA62B0A1C8107EA8EDF534442');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($k, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'main', $a, $d, $e), 2 => $n, 3 => $r, 4 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($b, $h, 'main', $s, $a), 5 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $m, $h, $a, $d, true, $o), 6 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5b27736cf40516.84104851', $a, $h), 7 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('debug.security.access.decision_manager'), $k, $h)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $e, $l, 'main', $s, NULL, NULL, $a, false));
    }
    ...
    protected function getSncRedis_CacheService()
    {
        ...
        return $this->services['snc_redis.cache'] = new \Predis\Client(new \Predis\Connection\Parameters(array('profile' => '2.2', 'read_write_timeout' => 30, 'iterable_multibulk' => false, 'prefix' => NULL, 'replication' => false, 'async_connect' => false, 'timeout' => 10, 'persistent' => false, 'exceptions' => true, 'logging' => true, 'alias' => 'cache', 'scheme' => 'tcp', 'host' => 'localhost', 'port' => 6379, 'database' => 1, 'password' => NULL, 'weight' => NULL)), new \Predis\Configuration\Options(array('profile' => $a, 'read_write_timeout' => 30, 'iterable_multibulk' => false, 'prefix' => NULL, 'replication' => false, 'async_connect' => false, 'timeout' => 10, 'persistent' => false, 'exceptions' => true, 'connections' => $b)));
    }
    ...
    protected function getSncRedis_SessionService()
    {
        ...
        return $this->services['snc_redis.session'] = new \Predis\Client(new \Predis\Connection\Parameters(array('read_write_timeout' => NULL, 'iterable_multibulk' => false, 'profile' => 'default', 'prefix' => NULL, 'replication' => false, 'async_connect' => false, 'timeout' => 5, 'persistent' => false, 'exceptions' => true, 'logging' => true, 'alias' => 'session', 'scheme' => 'tcp', 'host' => 'localhost', 'port' => 6379, 'database' => 2, 'password' => NULL, 'weight' => NULL)), new \Predis\Configuration\Options(array('read_write_timeout' => NULL, 'iterable_multibulk' => false, 'profile' => $a, 'prefix' => NULL, 'replication' => false, 'async_connect' => false, 'timeout' => 5, 'persistent' => false, 'exceptions' => true, 'connections' => $b)));
    }
